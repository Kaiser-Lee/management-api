...
public final class StrTools {
	...
	public static void main(String[] args) {
		utils.SystemUtils.printLog(StrTools.isFloat("0"));
		utils.SystemUtils.printLog(StrTools.isFloat("4.3"));
		utils.SystemUtils.printLog(StrTools.isFloat("43.4"));
		utils.SystemUtils.printLog(StrTools.isFloat("4.3.4"));
		utils.SystemUtils.printLog(StrTools.isFloat("-2.3"));
