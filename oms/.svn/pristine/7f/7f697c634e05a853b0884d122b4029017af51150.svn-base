...
import com.iwhalecloud.retail.goods.dto.TagsDTO;
    ...
    public boolean addContentPic(String goodsId, String actionType, String userId) throws Exception {
        ...
        switch (actionType) {
            case "add":
                ...
                contentBase.setTitle(goods.getName());
                contentBase.setDesp(goods.getSelling_point());
                ...
                String contentUrl = goods.getMbl_image_file();
                String http = "http.*";
                ...
                ResultVO<List<TagsDTO>> rsv = tagsOpenService.getTagsByGoodsId(goodsId);
                List<TagsDTO> tagsList = rsv.getResultData();
                int i = 0;
                //去t_tag中查询
                for (TagsDTO tags : tagsList) {
