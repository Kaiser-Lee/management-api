...
public class DBTUtil {
	...
	public static void main(String[] a ){
		utils.SystemUtils.printLog(decode("hj_bz", "1", "'总库入'", "2", "'总库出'","3","'分库出'","4","'已开票'","5","'已安装'","6","'已收款'")) ;
		utils.SystemUtils.printLog(decode("hj_bz", "1", "'总库入'", "2", "'总库出'")) ;
		utils.SystemUtils.printLog(decode("hj_bz", "1", "'总库入'", "'总库出'")) ;
	}
